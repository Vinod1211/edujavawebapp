...
public class DataValidator {
	...
	// validate the name or any text filed to check only it is have characters
	public static boolean isName(String val) {
	  ...
	  //validate the fields that only have numbers
	  ...
	  //validate the password that must in the form of Demo@123 and the length should be 6-12
